...
--              {description = "take a screenshot", group = "hotkeys"}),
   ...
   -- awful.key({ altkey, "Control" }, "0",
    ...
    awful.key({ modkey }, "w", function () awful.spawn("firefox-developer-edition") end, 
              {description = "run firefox", group = "launcher"}),            
     awful.key({ modkey }, "a", function () awful.spawn("vscodium") end,
           {description = "run vscodium", group = "launcher"}),     
    awful.key({ modkey }, "z", function () awful.spawn("rofi -show drun")end,
   	      {description = "run rofi", group = "launcher"}),
    --awful.key({ modkey }, "p", function () awful.spawn("obsidian") end,
