...
theme.wallpaper                                 = "~/Downloads/wallpapers/ice.jpg" 
theme.font                                      = "Merriweather 9.5"
theme.fg_normal                                 = "#d8dee9" -- font color
theme.fg_focus                                  = "#5e81ac" -- font when focused
theme.fg_urgent                                 = "#CC9393"
theme.bg_normal                                 = "#3B4252" -- color of wibar top etc
theme.bg_focus                                  = "#3B4252"  -- focused wibar and window or tag
theme.bg_urgent                                 = "#3B4252"  
theme.border_width                              = dpi(1)
theme.border_normal                             = "#302627"
theme.border_focus                              = "#D8DEE9"
theme.border_marked                             = "#CC9393"
theme.taglist_fg_focus                          = "#7289da"
theme.tasklist_bg_focus                         = "#2f383e"
theme.tasklist_fg_focus                         = "#88c0d0"
...
local temp = lain.widget.temp({
    settings = function()
        widget:set_markup(markup.font(theme.font, markup(gray, " Temp ") .. coretemp_now .. "°C  " ))
    end
})    
